function [rxdataIQ] = OFDM_RFLoopback_1ant(txdataIQ,antindex,txantnum,txindex,pcip,xsrpip)
...
test_Set_router = uint8(hex2dec({'00','00','99','bb', '68','00','00','00',  '00','06','00','00',  '00','00','00','00',  '00','00','00','00'}));%TX0发射，RX0数据发送给网口
test_Set_router1 = uint8(hex2dec({'00','00','99','bb', '68','00','00','00',  '00','06','00','00',  '00','01','00','00',  '00','00','00','00'}));%TX0发射，RX1数据发送给网口
test_Set_router2 = uint8(hex2dec({'00','00','99','bb', '68','00','00','00',  '00','00','00','06',  '00','00','00','00',  '00','00','00','00'}));%TX1发射，RX0数据发送给网口
test_Set_router3 = uint8(hex2dec({'00','00','99','bb', '68','00','00','00',  '00','00','00','06',  '00','01','00','00',  '00','00','00','00'}));%TX1发射，RX1数据发送给网口
test_Set_router4 = uint8(hex2dec({'00','00','99','bb', '68','00','00','00',  '00','06','00','06',  '00','00','00','00',  '00','00','00','00'}));%TX0和TX1发射，RX0数据发送给网口
test_Set_router5 = uint8(hex2dec({'00','00','99','bb', '68','00','00','00',  '00','06','00','06',  '00','01','00','00',  '00','00','00','00'}));%TX0和TX1发射，RX1数据发送给网口
...
test_tx_command = uint8(hex2dec({'00','00','99','bb', '65','0A','03','FF',  '00','01','78','00',  '00','00','00','00',  '00','00','00','00'}));
...
% test_Get_IQ  = uint8(hex2dec({'00','00','99','bb', '66','01','00','01',  '01','00','00','F0',  '00','00','00','00',  '00','00','00','00'}));%01 采集时隙号，0000 分频，0060 包的数量96，00F0 包的大小240（实际接收字节数为配置值乘以4）%OK
test_Get_IQ  = uint8(hex2dec({'00','00','99','bb', '66','01','00','01',  '00','80','00','F0',  '00','00','00','00',  '00','00','00','00'}));
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%创建UDP对象，并打开
udp_obj = udp(xsrpip,13345,'LocalHost',pcip,'LocalPort',12345,'TimeOut',15,'OutputBufferSize',61440,'InputBufferSize',61440*10);
udp_obj.Timeout=15;
fopen(udp_obj);
...
if(0 == antindex)  %RX0接收
    if(2 == txantnum)
        fwrite(udp_obj, test_Set_router4,  'uint8'); %TX0和TX1发射RX0接收
    else
        if(0 ==txindex)
            fwrite(udp_obj, test_Set_router,  'uint8'); %TX0发射RX0接收
        else
            fwrite(udp_obj, test_Set_router2,  'uint8'); %TX1发射RX0接收
        end
    end
    
else
    if(2 == txantnum)
        fwrite(udp_obj, test_Set_router5,  'uint8');  %TX0和TX1发射RX1接收
    else
        if(0 ==txindex)
            fwrite(udp_obj, test_Set_router1,  'uint8'); %TX0发射RX1接收
        else
            fwrite(udp_obj, test_Set_router3,  'uint8'); %TX1发射RX1接收
        end
    end
